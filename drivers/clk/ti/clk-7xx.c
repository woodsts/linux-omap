...
static const struct omap_clkctrl_reg_data dra7_ipu1_clkctrl_regs[] __initconst = {
	{ DRA7_IPU1_MMU_IPU1_CLKCTRL, dra7_mmu_ipu1_bit_data, CLKF_HW_SUP, "ipu1_clkctrl:0000:24" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_ipu_clkctrl_regs[] __initconst = {
	{ DRA7_IPU_MCASP1_CLKCTRL, dra7_mcasp1_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0000:22" },
	{ DRA7_IPU_TIMER5_CLKCTRL, dra7_timer5_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0008:24" },
	{ DRA7_IPU_TIMER6_CLKCTRL, dra7_timer6_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0010:24" },
	{ DRA7_IPU_TIMER7_CLKCTRL, dra7_timer7_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0018:24" },
	{ DRA7_IPU_TIMER8_CLKCTRL, dra7_timer8_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0020:24" },
	{ DRA7_IPU_I2C5_CLKCTRL, NULL, CLKF_SW_SUP, "func_96m_fclk" },
	{ DRA7_IPU_UART6_CLKCTRL, dra7_uart6_bit_data, CLKF_SW_SUP, "ipu_clkctrl:0030:24" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_atl_clkctrl_regs[] __initconst = {
	{ DRA7_ATL_ATL_CLKCTRL, dra7_atl_bit_data, CLKF_SW_SUP, "atl_clkctrl:0000:26" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_dss_clkctrl_regs[] __initconst = {
	{ DRA7_DSS_DSS_CORE_CLKCTRL, dra7_dss_core_bit_data, CLKF_SW_SUP, "dss_clkctrl:0000:8" },
...
static const struct omap_clkctrl_reg_data dra7_l3init_clkctrl_regs[] __initconst = {
	{ DRA7_L3INIT_MMC1_CLKCTRL, dra7_mmc1_bit_data, CLKF_SW_SUP, "l3init_clkctrl:0008:25" },
	{ DRA7_L3INIT_MMC2_CLKCTRL, dra7_mmc2_bit_data, CLKF_SW_SUP, "l3init_clkctrl:0010:25" },
...
static const struct omap_clkctrl_reg_data dra7_l4per_clkctrl_regs[] __initconst = {
	{ DRA7_L4PER_TIMER10_CLKCTRL, dra7_timer10_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0000:24" },
	{ DRA7_L4PER_TIMER11_CLKCTRL, dra7_timer11_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0008:24" },
	{ DRA7_L4PER_TIMER2_CLKCTRL, dra7_timer2_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0010:24" },
	{ DRA7_L4PER_TIMER3_CLKCTRL, dra7_timer3_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0018:24" },
	{ DRA7_L4PER_TIMER4_CLKCTRL, dra7_timer4_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0020:24" },
	{ DRA7_L4PER_TIMER9_CLKCTRL, dra7_timer9_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0028:24" },
	...
	{ DRA7_L4PER_MMC3_CLKCTRL, dra7_mmc3_bit_data, CLKF_SW_SUP, "l4per_clkctrl:00f8:25" },
	{ DRA7_L4PER_MMC4_CLKCTRL, dra7_mmc4_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0100:25" },
	{ DRA7_L4PER_UART1_CLKCTRL, dra7_uart1_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0118:24" },
	{ DRA7_L4PER_UART2_CLKCTRL, dra7_uart2_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0120:24" },
	{ DRA7_L4PER_UART3_CLKCTRL, dra7_uart3_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0128:24" },
	{ DRA7_L4PER_UART4_CLKCTRL, dra7_uart4_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0130:24" },
	{ DRA7_L4PER_UART5_CLKCTRL, dra7_uart5_bit_data, CLKF_SW_SUP, "l4per_clkctrl:0148:24" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_l4per2_clkctrl_regs[] __initconst = {
	...
	{ DRA7_L4PER2_QSPI_CLKCTRL, dra7_qspi_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:012c:25" },
	{ DRA7_L4PER2_MCASP2_CLKCTRL, dra7_mcasp2_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:0154:22" },
	{ DRA7_L4PER2_MCASP3_CLKCTRL, dra7_mcasp3_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:015c:22" },
	{ DRA7_L4PER2_MCASP5_CLKCTRL, dra7_mcasp5_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:016c:22" },
	{ DRA7_L4PER2_MCASP8_CLKCTRL, dra7_mcasp8_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:0184:24" },
	{ DRA7_L4PER2_MCASP4_CLKCTRL, dra7_mcasp4_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:018c:22" },
	{ DRA7_L4PER2_UART7_CLKCTRL, dra7_uart7_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:01c4:24" },
	{ DRA7_L4PER2_UART8_CLKCTRL, dra7_uart8_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:01d4:24" },
	{ DRA7_L4PER2_UART9_CLKCTRL, dra7_uart9_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:01dc:24" },
	{ DRA7_L4PER2_DCAN2_CLKCTRL, NULL, CLKF_SW_SUP, "sys_clkin1" },
	{ DRA7_L4PER2_MCASP6_CLKCTRL, dra7_mcasp6_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:01f8:22" },
	{ DRA7_L4PER2_MCASP7_CLKCTRL, dra7_mcasp7_bit_data, CLKF_SW_SUP, "l4per2_clkctrl:01fc:22" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_l4per3_clkctrl_regs[] __initconst = {
	...
	{ DRA7_L4PER3_TIMER13_CLKCTRL, dra7_timer13_bit_data, CLKF_SW_SUP, "l4per3_clkctrl:00b4:24" },
	{ DRA7_L4PER3_TIMER14_CLKCTRL, dra7_timer14_bit_data, CLKF_SW_SUP, "l4per3_clkctrl:00bc:24" },
	{ DRA7_L4PER3_TIMER15_CLKCTRL, dra7_timer15_bit_data, CLKF_SW_SUP, "l4per3_clkctrl:00c4:24" },
	{ DRA7_L4PER3_TIMER16_CLKCTRL, dra7_timer16_bit_data, CLKF_SW_SUP, "l4per3_clkctrl:011c:24" },
	{ 0 },
};
...
static const struct omap_clkctrl_reg_data dra7_wkupaon_clkctrl_regs[] __initconst = {
	...
	{ DRA7_WKUPAON_TIMER1_CLKCTRL, dra7_timer1_bit_data, CLKF_SW_SUP, "wkupaon_clkctrl:0020:24" },
	{ DRA7_WKUPAON_TIMER12_CLKCTRL, NULL, 0, "secure_32k_clk_src_ck" },
	{ DRA7_WKUPAON_COUNTER_32K_CLKCTRL, NULL, 0, "wkupaon_iclk_mux" },
	{ DRA7_WKUPAON_UART10_CLKCTRL, dra7_uart10_bit_data, CLKF_SW_SUP, "wkupaon_clkctrl:0060:24" },
	{ DRA7_WKUPAON_DCAN1_CLKCTRL, dra7_dcan1_bit_data, CLKF_SW_SUP, "wkupaon_clkctrl:0068:24" },
...
static struct ti_dt_clk dra7xx_clks[] = {
	...
	DT_CLK(NULL, "atl_dpll_clk_mux", "atl_clkctrl:0000:24"),
	DT_CLK(NULL, "atl_gfclk_mux", "atl_clkctrl:0000:26"),
	DT_CLK(NULL, "dcan1_sys_clk_mux", "wkupaon_clkctrl:0068:24"),
	DT_CLK(NULL, "dss_32khz_clk", "dss_clkctrl:0000:11"),
	DT_CLK(NULL, "dss_48mhz_clk", "dss_clkctrl:0000:9"),
	DT_CLK(NULL, "dss_dss_clk", "dss_clkctrl:0000:8"),
	DT_CLK(NULL, "dss_hdmi_clk", "dss_clkctrl:0000:10"),
	DT_CLK(NULL, "dss_video1_clk", "dss_clkctrl:0000:12"),
	DT_CLK(NULL, "dss_video2_clk", "dss_clkctrl:0000:13"),
	DT_CLK(NULL, "gmac_rft_clk_mux", "gmac_clkctrl:0000:25"),
	DT_CLK(NULL, "gpio1_dbclk", "wkupaon_clkctrl:0018:8"),
	DT_CLK(NULL, "gpio2_dbclk", "l4per_clkctrl:0038:8"),
	DT_CLK(NULL, "gpio3_dbclk", "l4per_clkctrl:0040:8"),
	DT_CLK(NULL, "gpio4_dbclk", "l4per_clkctrl:0048:8"),
	DT_CLK(NULL, "gpio5_dbclk", "l4per_clkctrl:0050:8"),
	DT_CLK(NULL, "gpio6_dbclk", "l4per_clkctrl:0058:8"),
	DT_CLK(NULL, "gpio7_dbclk", "l4per_clkctrl:00e8:8"),
	DT_CLK(NULL, "gpio8_dbclk", "l4per_clkctrl:00f0:8"),
	DT_CLK(NULL, "ipu1_gfclk_mux", "ipu1_clkctrl:0000:24"),
	DT_CLK(NULL, "mcasp1_ahclkr_mux", "ipu_clkctrl:0000:28"),
	DT_CLK(NULL, "mcasp1_ahclkx_mux", "ipu_clkctrl:0000:24"),
	DT_CLK(NULL, "mcasp1_aux_gfclk_mux", "ipu_clkctrl:0000:22"),
	DT_CLK(NULL, "mcasp2_ahclkr_mux", "l4per2_clkctrl:0154:28"),
	DT_CLK(NULL, "mcasp2_ahclkx_mux", "l4per2_clkctrl:0154:24"),
	DT_CLK(NULL, "mcasp2_aux_gfclk_mux", "l4per2_clkctrl:0154:22"),
	DT_CLK(NULL, "mcasp3_ahclkx_mux", "l4per2_clkctrl:015c:24"),
	DT_CLK(NULL, "mcasp3_aux_gfclk_mux", "l4per2_clkctrl:015c:22"),
	DT_CLK(NULL, "mcasp4_ahclkx_mux", "l4per2_clkctrl:018c:24"),
	DT_CLK(NULL, "mcasp4_aux_gfclk_mux", "l4per2_clkctrl:018c:22"),
	DT_CLK(NULL, "mcasp5_ahclkx_mux", "l4per2_clkctrl:016c:24"),
	DT_CLK(NULL, "mcasp5_aux_gfclk_mux", "l4per2_clkctrl:016c:22"),
	DT_CLK(NULL, "mcasp6_ahclkx_mux", "l4per2_clkctrl:01f8:24"),
	DT_CLK(NULL, "mcasp6_aux_gfclk_mux", "l4per2_clkctrl:01f8:22"),
	DT_CLK(NULL, "mcasp7_ahclkx_mux", "l4per2_clkctrl:01fc:24"),
	DT_CLK(NULL, "mcasp7_aux_gfclk_mux", "l4per2_clkctrl:01fc:22"),
	DT_CLK(NULL, "mcasp8_ahclkx_mux", "l4per2_clkctrl:0184:22"),
	DT_CLK(NULL, "mcasp8_aux_gfclk_mux", "l4per2_clkctrl:0184:24"),
	DT_CLK(NULL, "mmc1_clk32k", "l3init_clkctrl:0008:8"),
	DT_CLK(NULL, "mmc1_fclk_div", "l3init_clkctrl:0008:25"),
	DT_CLK(NULL, "mmc1_fclk_mux", "l3init_clkctrl:0008:24"),
	DT_CLK(NULL, "mmc2_clk32k", "l3init_clkctrl:0010:8"),
	DT_CLK(NULL, "mmc2_fclk_div", "l3init_clkctrl:0010:25"),
	DT_CLK(NULL, "mmc2_fclk_mux", "l3init_clkctrl:0010:24"),
	DT_CLK(NULL, "mmc3_clk32k", "l4per_clkctrl:00f8:8"),
	DT_CLK(NULL, "mmc3_gfclk_div", "l4per_clkctrl:00f8:25"),
	DT_CLK(NULL, "mmc3_gfclk_mux", "l4per_clkctrl:00f8:24"),
	DT_CLK(NULL, "mmc4_clk32k", "l4per_clkctrl:0100:8"),
	DT_CLK(NULL, "mmc4_gfclk_div", "l4per_clkctrl:0100:25"),
	DT_CLK(NULL, "mmc4_gfclk_mux", "l4per_clkctrl:0100:24"),
	DT_CLK(NULL, "optfclk_pciephy1_32khz", "pcie_clkctrl:0000:8"),
	DT_CLK(NULL, "optfclk_pciephy1_clk", "pcie_clkctrl:0000:9"),
	DT_CLK(NULL, "optfclk_pciephy1_div_clk", "pcie_clkctrl:0000:10"),
	DT_CLK(NULL, "optfclk_pciephy2_32khz", "pcie_clkctrl:0008:8"),
	DT_CLK(NULL, "optfclk_pciephy2_clk", "pcie_clkctrl:0008:9"),
	DT_CLK(NULL, "optfclk_pciephy2_div_clk", "pcie_clkctrl:0008:10"),
	DT_CLK(NULL, "qspi_gfclk_div", "l4per2_clkctrl:012c:25"),
	DT_CLK(NULL, "qspi_gfclk_mux", "l4per2_clkctrl:012c:24"),
	DT_CLK(NULL, "rmii_50mhz_clk_mux", "gmac_clkctrl:0000:24"),
	DT_CLK(NULL, "sata_ref_clk", "l3init_clkctrl:0068:8"),
	DT_CLK(NULL, "timer10_gfclk_mux", "l4per_clkctrl:0000:24"),
	DT_CLK(NULL, "timer11_gfclk_mux", "l4per_clkctrl:0008:24"),
	DT_CLK(NULL, "timer13_gfclk_mux", "l4per3_clkctrl:00b4:24"),
	DT_CLK(NULL, "timer14_gfclk_mux", "l4per3_clkctrl:00bc:24"),
	DT_CLK(NULL, "timer15_gfclk_mux", "l4per3_clkctrl:00c4:24"),
	DT_CLK(NULL, "timer16_gfclk_mux", "l4per3_clkctrl:011c:24"),
	DT_CLK(NULL, "timer1_gfclk_mux", "wkupaon_clkctrl:0020:24"),
	DT_CLK(NULL, "timer2_gfclk_mux", "l4per_clkctrl:0010:24"),
	DT_CLK(NULL, "timer3_gfclk_mux", "l4per_clkctrl:0018:24"),
	DT_CLK(NULL, "timer4_gfclk_mux", "l4per_clkctrl:0020:24"),
	DT_CLK(NULL, "timer5_gfclk_mux", "ipu_clkctrl:0008:24"),
	DT_CLK(NULL, "timer6_gfclk_mux", "ipu_clkctrl:0010:24"),
	DT_CLK(NULL, "timer7_gfclk_mux", "ipu_clkctrl:0018:24"),
	DT_CLK(NULL, "timer8_gfclk_mux", "ipu_clkctrl:0020:24"),
	DT_CLK(NULL, "timer9_gfclk_mux", "l4per_clkctrl:0028:24"),
	DT_CLK(NULL, "uart10_gfclk_mux", "wkupaon_clkctrl:0060:24"),
	DT_CLK(NULL, "uart1_gfclk_mux", "l4per_clkctrl:0118:24"),
	DT_CLK(NULL, "uart2_gfclk_mux", "l4per_clkctrl:0120:24"),
	DT_CLK(NULL, "uart3_gfclk_mux", "l4per_clkctrl:0128:24"),
	DT_CLK(NULL, "uart4_gfclk_mux", "l4per_clkctrl:0130:24"),
	DT_CLK(NULL, "uart5_gfclk_mux", "l4per_clkctrl:0148:24"),
	DT_CLK(NULL, "uart6_gfclk_mux", "ipu_clkctrl:0030:24"),
	DT_CLK(NULL, "uart7_gfclk_mux", "l4per2_clkctrl:01c4:24"),
	DT_CLK(NULL, "uart8_gfclk_mux", "l4per2_clkctrl:01d4:24"),
	DT_CLK(NULL, "uart9_gfclk_mux", "l4per2_clkctrl:01dc:24"),
	DT_CLK(NULL, "usb_otg_ss1_refclk960m", "l3init_clkctrl:00d0:8"),
	DT_CLK(NULL, "usb_otg_ss2_refclk960m", "l3init_clkctrl:0020:8"),
	{ .node_name = NULL },
};
